...
#grpc-method {
  ...
  background: transparent
    url("data:image/svg+xml;utf8,<svg version='1.1' viewBox='0 0 32 48' x='0' xmlns='http://www.w3.org/2000/svg' y='0' aria-hidden='true' style='margin-right: -25px;'><polygon points='17.3 8.3 12 13.6 6.7 8.3 5.3 9.7 12 16.4 18.7 9.7 '></polygon></svg>")
    no-repeat;
